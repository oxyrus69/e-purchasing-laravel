...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Edit Data Produk') }}</h2>
    </x-slot>
    <div class="py-12">
                    ...
                    <form method="POST" action="{{ route('products.update', $product->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="code" id="code" value="{{ old('code', $product->code) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                            ...
                            <div>
                             ...
                             <div class="md:col-span-2">
                                ...
                                <input type="text" name="unit" id="unit" value="{{ old('unit', $product->unit) }}" placeholder="Contoh: Pcs, Kg, Box, Unit" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
